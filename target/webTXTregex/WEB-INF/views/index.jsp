...
<html>  
    <head>  
        ...
        <script type="text/javascript" src="${initParam.resources}/resources/exlib/fileinput/js/fileinput.min.js" ></script>
       			...
       			<div class="col-xs-12 col-sm-12">
                    ...
                    <div class="jumbotron">
            			...
            			<div class="introduction">
            				...
            				<p>1. 主标题（无标记）表示允许文档中存在一系列无标记的主标题，为了区分主标题，除第一个主标题外，后续主标题前必须存在空行：<img src="${initParam.resources}/resources/pic/001-001.png"/></p>
            				<p>创建正则约束时可以不输入标记:<img src="${initParam.resources}/resources/pic/001-002.png"/></p>
            			</div>
                    </div><!-- 巨幕 -->
